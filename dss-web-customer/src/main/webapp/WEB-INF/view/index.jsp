...
<head>
    ...
    <link rel="shortcut icon" href="favicon.ico"> <link href="${context}/css/bootstrap.min.css?v=3.3.6" rel="stylesheet">
    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="${context}/back/userInfo/page" data-index="0">用户管理</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="${context}/back/authInfo/rolePage">角色管理</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="${context}/back/deptInfo/page">部门管理</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="${context}/back/authInfo/resourcePage">资源管理</a>
                            </li>
                           <%-- <li>
                                <a href="index_v5.html" target="_blank">用户部门配置</a>
                            </li>--%>
                        </ul>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row content-tabs">
                ...
                <a href="${context}/logout" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
            </div>
